...
// Buat array data nama CPMI berdasarkan urutan
$dataCPMI = [];
...
foreach ($dataCPMI as $index => $cpm) {
    if ($cpm['id'] == $id) {
        $urut = $index + 1; // Posisi dalam daftar (1-based index)
        break;
    }
}
...
// Debugging (opsional)
echo "Prefix: {$prefix}, Urutan: {$urut}, Nomor Seri: {$nomorSeri}";
...
$backgroundUrlPage1 = 'https://bahanamegaprestasi.id/wp-content/uploads/2025/01/konstruksi.jpg';
...
<body>
    ...
    <div class='content-container'>
        ...
        Menerangkan bahwa siswa <span><b>{$namaCPM}</b></span> telah mendapatkan Pelatihan Dasar Konstruksi<br>
...
$mpdf->AddPage();
$backgroundUrlPage2 = 'https://bahanamegaprestasi.id/wp-content/uploads/2025/01/Konstruksi-belakang.jpg';
