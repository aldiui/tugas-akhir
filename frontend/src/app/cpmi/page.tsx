...
import { adminCpmiGetAll } from '@/services/user-service';
...
export default function Page() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryKey: ['list-cpmi', page, limit, search, sort],
  });
      ...
      <div className="w-full h-full p-6 space-y-4">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>CPMI</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        <Card>
          <CardHeader className="border-b">
            <div className="flex justify-between items-center">
              <h3 className="text-2xl font-bold text-blue-900">CPMI</h3>
            </div>
          </CardHeader>
