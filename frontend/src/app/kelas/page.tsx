...
import { adminKelasGetAll } from '@/services/kelas-service';
...
export default function Page() {
  ...
  const { canCreate } = usePermissions('KLS');

  const { data, isLoading } = useQuery({
    queryFn: async () =>
      await adminKelasGetAll({
        page,
        limit,
        search,
        sort_by: sort?.type,
    ...
    queryKey: ['list-kelas', page, limit, search, sort],
  });
        ...
        <Card>
          <CardHeader className="border-b">
            <div className="flex justify-between items-center">
              <h3 className="text-2xl font-bold text-blue-900">Kelas</h3>
