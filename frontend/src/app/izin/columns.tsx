...
import { adminIzinDelete } from '@/services/izin-service';
...
export const columns: ColumnDef<Izin>[] = [
  ...
  },
  {
    ...
    header: ({ column }) => {
      return (
        <TableSortableHeader column={column} columnName="tanggal_mulai" label="Tanggal Mulai" />
      );
    },
  ...
  },
  {
    ...
    header: ({ column }) => {
      return (
        <TableSortableHeader column={column} columnName="tanggal_selesai" label="Tanggal Selesai" />
      );
    },
  ...
  {
    accessorKey: 'cpmi',
    header: ({ column }) => <TableSortableHeader column={column} columnName="cpmi" label="CPMI" />,
