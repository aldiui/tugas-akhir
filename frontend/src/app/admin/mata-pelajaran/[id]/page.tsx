...
import { adminMataPelajaranGetById, adminMataPelajaranUpdate } from '@/services/mata-pelajaran-service'
        ...
        <div className="w-full h-full p-6 space-y-4">
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbLink href="/admin/mata-pelajaran">Mata Pelajaran</BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
