...
import { adminNotifikasiGetAll } from '@/services/notifikasi-service'
...
export default function Page() {
    ...
    const { data, isLoading } = useQuery({
        ...
        queryKey: ['list-notifikasi', page, limit, search, sort],
    })
            ...
            <Card>
                <CardHeader className="border-b">
                    <div className="flex justify-between items-center">
                        <h3 className="text-2xl font-bold text-blue-900">Notifikasi</h3>
