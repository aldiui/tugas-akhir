...
export default function Page() {
    ...
    const mutation = useMutation({
        mutationFn: (data: z.infer<typeof createUserSchema>) => adminUserCreate(data),
        onSuccess: (data) => {
            if (data?.status === 201) {
            ...
            if (error instanceof AxiosError && error.response) {
                ...
                if (errors) {
                    Object.keys(errors).forEach(key => {
                        return form.setError(key as "nama" | "role_id" | "lokasi_id" | "email" | "nomor_telepon" | "alamat" | "password" | "konfirmasi_password", {
                            type: 'manual',
            ...
            <Card>
                <CardHeader className="border-b">
                    <div className="flex justify-between items-center">
                        <h3 className="text-2xl font-bold text-blue-900">Tambah User</h3>
                    </div>
                </CardHeader>
