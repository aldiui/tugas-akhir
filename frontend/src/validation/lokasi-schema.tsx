...
const createLokasiSchema = z.object({
    kode : z.string().min(1, "Kode lokasi tidak boleh kosong"),
    nama : z.string().min(1, "Nama lokasi tidak boleh kosong"),
    latitude : z.number({ message: "Latitude harus berupa angka" }),
    longitude : z.number({ message: "Longitude harus berupa angka" }),
    ...
    radius : z.number({ message: "Radius harus berupa angka" }).min(1, "Radius harus lebih dari 0"),
    alamat : z.string().optional(),
    telepon : z.string().min(1, "Telepon tidak boleh kosong"),
});

export { createLokasiSchema };
