...
export const adminKelasCreate = async (body: unknown) => {
    return api.post<ApiResponse<Kelas>>('/api/lpk-admin/kelas', body)
}

export const adminKelasUpdate = async (id: string, body: unknown) => {
    return api.put<ApiResponse<Kelas>>(`/api/lpk-admin/kelas/${id}`, body)
}
...
export const adminKelasGetAll = async (params: unknown) => {
    return api.get<ApiResponse<PaginationData<Kelas[]>>>('/api/lpk-admin/kelas', { params })
}

export const adminKelasGetById = async (id: string) => {
    return api.get<ApiResponse<Kelas>>(`/api/lpk-admin/kelas/${id}`)
}
