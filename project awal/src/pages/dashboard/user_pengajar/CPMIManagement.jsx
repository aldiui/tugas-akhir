...
const CPMIManagement = () => {
  ...
  // Filter CPMI based on search and status
  ...
  const handleSaveCPMI = () => {
    if (selectedCPMI) {
      ...
      setCpmiList(prev => prev.map(cpmi => 
        cpmi.id === selectedCPMI.id ? { ...formData, id: selectedCPMI.id } : cpmi
      ));
    } else {
      // Add new CPMI
      const newCPMI = {
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-light-border dark:border-dark-border rounded-lg bg-light-card dark:bg-dark-card text-light-text-main dark:text-dark-text-main focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                required
              >
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="w-4 h-4 text-primary-600 bg-light-card dark:bg-dark-card border-light-border dark:border-dark-border rounded focus:ring-primary-500"
              />
        ...
        return (
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 border border-light-border dark:border-dark-border rounded-lg bg-light-card dark:bg-dark-card text-light-text-main dark:text-dark-text-main focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none"
              required
            />
          </div>
        );
      ...
      <div className="p-4 pb-20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <div className="relative flex-1">
            ...
            <input
              type="text"
              placeholder="Cari nama atau email CPMI..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full pl-10 pr-4 py-2 border border-light-border dark:border-dark-border rounded-lg bg-light-card dark:bg-dark-card text-light-text-main dark:text-dark-text-main focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            />
          </div>
          ...
          <div className="relative">
            ...
            <select
              ...
              className="pl-10 pr-8 py-2 border border-light-border dark:border-dark-border rounded-lg bg-light-card dark:bg-dark-card text-light-text-main dark:text-dark-text-main focus:ring-2 focus:ring-primary-500 focus:border-transparent appearance-none"
            >
          ...
          {filteredCPMI.map((cpmi, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-light-card dark:bg-dark-card border border-light-border dark:border-dark-border rounded-xl p-4"
              >
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-light-text-main dark:text-dark-text-main">
                  {selectedCPMI ? 'Edit CPMI' : 'Tambah CPMI Baru'}
                </h2>
                <button
                  onClick={() => {
                    setShowAddModal(false);
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 border border-light-border dark:border-dark-border rounded-lg bg-light-body dark:bg-dark-body text-light-text-main dark:text-dark-text-main focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none"
                    required
                  />
                </div>
              </div>
        ...
        {showStatusModal && (
          ...
          >
            <motion.div
              ...
              exit={{ scale: 0.95, opacity: 0 }}
              onClick={(e) => e.stopPropagation()}
              className="bg-light-card dark:bg-dark-card rounded-xl p-6 w-full max-w-md"
            >
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-light-text-main dark:text-dark-text-main">
                  Ubah Status CPMI
              ...
              {selectedCPMI && (
                <div className="mb-4 p-3 bg-light-body dark:bg-dark-body rounded-lg">
                  <p className="text-sm text-secondary">Mengubah status untuk:</p>
