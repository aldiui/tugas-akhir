...
const Settings = () => {
  ...
  const pengajarData = {
    ...
    email: 'budi.hartono@lpk.com',
    telepon: '+62 812-3456-7890',
    kelas: 'Kelas Bahasa Mandarin A1',
    jumlahCPMI: 25
  };
  ...
  const quickActions = [
    ...
    },
    {
      id: 'location',
      title: 'Location',
      description: 'Setting lokasi absensi kelas',
      icon: MapPin,
  ...
  const helpActions = [
    ...
    },
    {
      ...
      icon: BookOpen,
      path: '/dashboard/pengajar/user-guide',
      color: 'indigo'
    }
  ];
        ...
        >
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-light-text-main dark:text-dark-text-main font-medium">Pengajar</span>
            </div>
            <div className="flex justify-between">
