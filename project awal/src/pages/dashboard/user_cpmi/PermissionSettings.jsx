        ...
        >
          ...
          <div className="space-y-3 text-sm text-secondary">
            <div className="flex items-start space-x-2">
              ...
              <p>Izin lokasi diperlukan untuk memastikan Anda berada di area kelas saat absensi</p>
            </div>
            <div className="flex items-start space-x-2">
              <div className="w-2 h-2 bg-primary-600 rounded-full mt-2 flex-shrink-0"></div>
              <p>Notifikasi membantu Anda tidak melewatkan jadwal pelajaran dan pengumuman penting</p>
            </div>
            <div className="flex items-start space-x-2">
              <div className="w-2 h-2 bg-primary-600 rounded-full mt-2 flex-shrink-0"></div>
              <p>Akses kamera diperlukan untuk mengambil foto dokumentasi saat laporan piket</p>
            </div>
            <div className="flex items-start space-x-2">
              <div className="w-2 h-2 bg-primary-600 rounded-full mt-2 flex-shrink-0"></div>
