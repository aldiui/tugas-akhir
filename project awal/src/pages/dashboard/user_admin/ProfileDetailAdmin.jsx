...
const ProfileDetailAdmin = () => {
  ...
  const [profilData, setProfilData] = useState({
    nama: 'Dr. Siti Nurhaliza, M.Ed',
    email: 'admin@lpkbahanamega.com',
    ...
    pengalaman: '12 tahun',
    spesialisasi: 'Manajemen LPK, Administrasi CPMI',
    nip: 'ADM001',
  ...
  return (
    <div className="min-h-screen bg-light-body dark:bg-dark-body">
      <BackHeader title="Detail Profil Admin" />
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-light-text-secondary dark:text-dark-text-secondary">
                  {profilData.role} - {profilData.spesialisasi}
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  value={profilData.role}
                  disabled={true}
                  className="w-full pl-10 pr-4 py-3 border border-light-border dark:border-dark-border rounded-lg bg-light-body dark:bg-dark-body text-light-text-main dark:text-dark-text-main opacity-50 cursor-not-allowed"
                />
              </div>
            </div>
