...
const SettingsAdmin = () => {
  ...
  const quickActions = [
    ...
    },
    {
      id: 'location',
      title: 'Location',
      description: 'Setting lokasi absensi global',
      icon: MapPin,
    ...
    },
    {
      ...
      description: 'Pengaturan izin aplikasi',
      icon: Shield,
  ...
  const helpActions = [
    ...
    },
    {
      id: 'guide',
      title: 'Panduan Admin',
      description: 'Tutorial mengelola sistem',
      icon: BookOpen,
      path: '/dashboard/admin/admin-guide',
      color: 'teal'
    },
    {
      id: 'backup',
      title: 'Data & Backup',
      description: 'Kelola backup dan restore data',
      icon: Database,
      path: '/dashboard/admin/data-backup',
      color: 'cyan'
    }
  ];
        ...
        >
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-light-text-main dark:text-dark-text-main font-medium">Administrator</span>
            </div>
            <div className="flex justify-between">
