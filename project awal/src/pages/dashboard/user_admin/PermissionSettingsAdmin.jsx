              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary">
                    Diperlukan untuk mengelola lokasi kelas dan validasi absensi CPMI
                  </p>
            ...
            <div className="flex items-center justify-between p-4 bg-light-body dark:bg-dark-body rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary">
                    Untuk mengirim dan menerima notifikasi sistem dan broadcast
                  </p>
                  <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary mt-1">
            ...
            <div className="flex items-center justify-between p-4 bg-light-body dark:bg-dark-body rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary">
                    Untuk mengambil foto profil dan dokumentasi sistem
                  </p>
                  <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary mt-1">
        ...
        >
          ...
          <div className="space-y-3 text-sm text-light-text-secondary dark:text-dark-text-secondary">
            <div className="flex items-start space-x-2">
              ...
              <p>Izin lokasi diperlukan untuk mengelola pengaturan lokasi kelas dan memvalidasi absensi CPMI</p>
            </div>
            <div className="flex items-start space-x-2">
              <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
              <p>Notifikasi membantu Anda mengirim broadcast dan menerima pemberitahuan sistem penting</p>
            </div>
            <div className="flex items-start space-x-2">
              <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
              <p>Akses kamera diperlukan untuk mengambil foto profil dan dokumentasi sistem</p>
            </div>
            <div className="flex items-start space-x-2">
              <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
              <p>Jika izin ditolak, beberapa fitur aplikasi mungkin tidak dapat berfungsi dengan optimal</p>
            </div>
            <div className="flex items-start space-x-2">
              <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
              <p>Sebagai admin, Anda memiliki akses penuh untuk mengelola semua aspek sistem LPK</p>
            </div>
          </div>
        </motion.div>
      </div>
...
export default PermissionSettingsAdmin;