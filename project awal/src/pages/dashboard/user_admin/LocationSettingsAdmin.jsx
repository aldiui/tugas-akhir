...
const LocationSettingsAdmin = () => {
  ...
  const [classes, setClasses] = useState([
    {
      id: 1,
      name: 'Kelas Bahasa Mandarin A1',
      instructor: 'Budi Hartono, S.Pd',
      studentCount: 25,
      latitude: -6.2088,
      longitude: 106.8456,
      radius: 50,
    ...
    {
      id: 2,
      name: 'Kelas Bahasa Mandarin A2',
      instructor: 'Sari Dewi, S.Pd',
      studentCount: 22,
      latitude: -6.2100,
      longitude: 106.8470,
      radius: 75,
    ...
    {
      id: 3,
      name: 'Kelas Bahasa Mandarin B1',
      instructor: 'Ahmad Rizki, S.Pd',
      studentCount: 18,
      latitude: -6.2120,
      longitude: 106.8490,
      radius: 60,
  ...
  // Location settings state for selected class
  const [locationSettings, setLocationSettings] = useState(null);

  // Select class and load its settings
  ...
  const handleSaveLocation = () => {
    ...
    setClasses(prev => prev.map(cls => 
      cls.id === selectedClass.id 
        ? {
            ...cls,
            name: locationSettings.className,
            ...
            isActive: locationSettings.isActive,
            lastUpdated: new Date().toLocaleString('id-ID')
          }
        : cls
    ));
  ...
  const testLocation = () => {
    const testDistance = Math.floor(Math.random() * 100);
  ...
  if (!selectedClass) {
    return (
      <div className="min-h-screen bg-light-body dark:bg-dark-body">
        <BackHeader title="Pengaturan Lokasi Kelas" />
        ...
        <div className="p-4 pt-5 pb-20">
          ...
          >
            ...
            <p className="text-light-text-secondary dark:text-dark-text-secondary">
              Pilih kelas yang ingin Anda atur lokasi absensinya
            </p>
          </motion.div>
          ...
          <div className="space-y-4">
            {classes.map((classData, index) => (
              <motion.div
                ...
                className="bg-light-card dark:bg-dark-card rounded-xl p-6 border border-light-border dark:border-dark-border cursor-pointer hover:bg-light-body dark:hover:bg-dark-body transition-colors"
              >
                      ...
                      <div className="flex items-center space-x-4 mt-2">
                        <div className="flex items-center space-x-1">
                          ...
                          <span className="text-sm text-light-text-secondary dark:text-dark-text-secondary">
                            {classData.studentCount} CPMI
                          </span>
                        </div>
                        <div className="flex items-center space-x-1">
                          <MapPin className="w-4 h-4 text-light-text-secondary dark:text-dark-text-secondary" />
                          <span className="text-sm text-light-text-secondary dark:text-dark-text-secondary">
                            Radius {classData.radius}m
                          </span>
                        </div>
  ...
  // Show location settings for selected class
  return (
    <div className="min-h-screen bg-light-body dark:bg-dark-body">
      <div className="flex items-center justify-between p-4 bg-light-card dark:bg-dark-card border-b border-light-border dark:border-dark-border">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-lg font-semibold text-light-text-main dark:text-dark-text-main">
              Pengaturan Lokasi
            </h1>
      ...
      <div className="p-4 pt-5 pb-20">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={() => setIsEditingClassName(!isEditingClassName)}
          ...
          <input
            ...
            disabled={!isEditingClassName}
            className="w-full px-4 py-3 border border-light-border dark:border-dark-border rounded-lg bg-light-body dark:bg-dark-body text-light-text-main dark:text-dark-text-main focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-light-border dark:border-dark-border rounded-lg bg-light-body dark:bg-dark-body text-light-text-main dark:text-dark-text-main focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <div className="mt-4">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                rows={3}
                className="w-full pl-10 pr-4 py-3 border border-light-border dark:border-dark-border rounded-lg bg-light-body dark:bg-dark-body text-light-text-main dark:text-dark-text-main focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
        ...
        >
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 px-6 py-4 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors font-medium"
          >
...
export default LocationSettingsAdmin;
